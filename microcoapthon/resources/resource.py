...
class Resource(object):
    ...
    def __init__(self, name, coap_server=None, visible=True, observable=True, allow_children=True):
        ...
        :param visible: if the resources is visible
        :param observable: if the resources is observable
        :param allow_children: if the resources could has children
        """
        if isinstance(name, Resource):
            ...
            # The attributes of this resources.
            self._attributes = {}
            ...
            # Indicates whether this resources is visible to clients.
            self._visible = visible

            # Indicates whether this resources is observable by clients.
    ...
    def etag(self):
        """
        Get the last valid ETag of the resources.

        :return: the ETag value or None if the resources doesn't have any ETag
        """
        if self._etag:
            return self._etag[-1]
        else:
    ...
    def payload(self):
        """
        Get the payload of the resources according to the content type specified by required_content_type or
    ...
    def payload(self, p):
        """
        Set the payload of the resources.
    ...
    def raw_payload(self):
        """
        Get the payload of the resources as a dict of all different payloads defined for the resources.
    ...
    def attributes(self):
        """
        Get the CoRE Link Format attribute of the resources.

        :return: the attribute of the resources
        """
    ...
    def attributes(self, att):
        # TODO assert
        """
        Set the CoRE Link Format attribute of the resources.
    ...
    def visible(self):
        """
        Get if the resources is visible.
    ...
    def visible(self, v):
        """
        Set if the resources is visible.
    ...
    def observable(self):
        """
        Get if the resources is observable.
    ...
    def observable(self, v):
        """
        Set if the resources is observable.
    ...
    def allow_children(self):
        """
        Get if the resources allow children.
    ...
    def allow_children(self, v):
        """
        Set if the resources  allow children.
    ...
    def content_type(self):
        """
        Get the CoRE Link Format ct attribute of the resources.
    ...
    def content_type(self, lst):
        """
        Set the CoRE Link Format ct attribute of the resources.

        :param lst: the list of CoRE Link Format ct attribute of the resources
        """
        value = []
    ...
    def add_content_type(self, ct):
        """
        Add a CoRE Link Format ct attribute to the resources.
    ...
    def resource_type(self):
        """
        Get the CoRE Link Format rt attribute of the resources.
    ...
    def resource_type(self, rt):
        """
        Set the CoRE Link Format rt attribute of the resources.
    ...
    def interface_type(self):
        """
        Get the CoRE Link Format if attribute of the resources.
    ...
    def interface_type(self, ift):
        """
        Set the CoRE Link Format if attribute of the resources.
    ...
    def maximum_size_estimated(self):
        """
        Get the CoRE Link Format sz attribute of the resources.
    ...
    def maximum_size_estimated(self, sz):
        """
        Set the CoRE Link Format sz attribute of the resources.
    ...
    def render_GET(self, request):
        """
        Method to be redefined to render a GET request on the resources.
    ...
    def render_PUT(self, request):
        """
        Method to be redefined to render a PUTT request on the resources.
    ...
    def render_POST(self, request):
        """
        Method to be redefined to render a POST request on the resources.
    ...
    def render_DELETE(self, request):
        """
        Method to be redefined to render a DELETE request on the resources.
