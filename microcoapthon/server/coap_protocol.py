...
from microcoapthon.layers.observe import ObserveLayer
from microcoapthon.layers.request import RequestLayer
from microcoapthon.layers.resource import ResourceLayer
...
class CoAP(socketserver.UDPServer):
    ...
    def finish_request(self, request, client_address):
        ...
        if isinstance(message, Request):
            ...
            logging.error("Received response")
            ...
            # ACK or RST
            logging.info("Received ACK or RST")
