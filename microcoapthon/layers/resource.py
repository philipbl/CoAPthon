...
class ResourceLayer(object):
    ...
    def edit_resource(self, request, response, node, lp, p):
        """
        Render a POST on an already created resources.

        :type node: coapthon2.utils.Tree
        :param request: the request
        :param response: the response
        :param node: the node which has the resources
        :param lp: the location_path attribute of the resources
        :param p: the local path of the resources (only the last section of the split path)
        :return: the response
        """
    ...
    def add_resource(self, request, response, old, lp, p):
        """
        Render a POST on a new resources.

        :type old: coapthon2.utils.Tree
        :param request: the request
        :param response: the response
        :param old: the node which has the parent of the resources
        :param lp: the location_path attribute of the resources
        :param p: the local path of the resources (only the last section of the split path)
        :return: the response
        """
    ...
    def get_resource(self, request, response, resource):
        ...
        :param request: the request
        :param response: the response
        :param resource: the resources required
        :return: the response
        """
